...
def init_domains_day(day, hours,areas):
    ...
    return domains
domains = init_domains_day("lunes",[9,10,15],["Seguridad Informatica"])+init_domains_day("martes",[9,10],["Seguridad Informatica"])
s1 = Speaker(init_domains_day("lunes",[9,10],["Seguridad Informatica"]), True, "CJ")
